      ...
      <div className="w-full max-w-xl rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-300 p-3 outline-none focus:border-primary"
          />
          ...
          <div className="flex justify-end gap-3 pt-3">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="rounded-xl bg-primary px-5 py-2 font-semibold text-white hover:bg-primary-dark"
            >
              Save Customer
            </button>
